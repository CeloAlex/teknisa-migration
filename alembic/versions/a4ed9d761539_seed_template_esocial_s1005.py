"""seed template esocial s1005

Fase 7 (eSocial) — S-1005 (Tabela de Estabelecimentos, Obras ou Unidades de Órgãos
Públicos) mapeia para ESTRUTURA com NRTIPOESTRUTURA=20 (mesma marcação usada para S-1000 —
ambos escrevem nas mesmas 3 tabelas, mas são eventos eSocial reais distintos: S-1000 é o
empregador, S-1005 é o estabelecimento). Tags confirmadas contra o XML real de exemplo
(`docs/eSocial/eventos_xml/XML_envio_S-1005_*.xml`), que já trouxe `cnaePrep` de verdade
(diferente de S-1000, onde CNAE vem só do webservice da Receita Federal e fica sem
origem) — essa é a principal diferença de fidelidade entre os dois.

Mesma ressalva de fidelidade parcial do S-1000: razão social, nome fantasia, endereço e
demais campos que a solução de referência busca via webservice não têm origem no XML
deste evento — ficam vazios/NULL, o que é seguro dado que não são obrigatórios.

Revision ID: a4ed9d761539
Revises: 6f30b1f0ac52
Create Date: 2026-07-16 16:25:05.625242
...
revision: str = 'a4ed9d761539'
down_revision: Union[str, None] = '6f30b1f0ac52'
branch_labels: Union[str, Sequence[str], None] = None
depends_on: Union[str, Sequence[str], None] = None

TEMPLATE_CODIGO = "ESOCIAL_S1005"
TIPO_CODIGO = "MIG_ESOCIAL_S1005"
SEM_ORIGEM = "_fixo_"
...
def upgrade() -> None:
    ...
    template_id = conn.execute(
        ...
        ),
        {
            ...
            "nome": "eSocial S-1005 — Tabela de Estabelecimentos (via Estrutura, NRTIPOESTRUTURA=20)",
            "versao": "v_S_01_03_00",
    ...
    campos = [
        ...
        campo(ordem=2, origem="evtTabEstab/infoEstab/inclusao/ideEstab/iniValid | "
                              "evtTabEstab/infoEstab/alteracao/ideEstab/iniValid",
        ...
        campo(ordem=3, origem="evtTabEstab/infoEstab/inclusao/ideEstab/fimValid | "
                              "evtTabEstab/infoEstab/alteracao/ideEstab/fimValid",
        ...
        campo(ordem=4, origem="evtTabEstab/infoEstab/inclusao/ideEstab/nrInsc | "
                              "evtTabEstab/infoEstab/alteracao/ideEstab/nrInsc",
              rotulo="CNPJ do estabelecimento", campo="CNPJ", marcador="@CNPJ@",
              destino_tabela="ESTRUTURAH", destino_coluna="CDCNPJESTRUT", tipo="texto",
              tamanho_maximo=14, regra_conversao="remover_mascara"),
        campo(ordem=5, origem="evtTabEstab/infoEstab/inclusao/dadosEstab/cnaePrep | "
                              "evtTabEstab/infoEstab/alteracao/dadosEstab/cnaePrep",
              rotulo="CNAE", campo="CDCNAE", marcador="@CDCNAE@",
        ...
        # --- campos sem origem no XML deste evento ---
    ...
    tipo_id = conn.execute(
        ...
        {"codigo": TIPO_CODIGO, "nome": "eSocial — S-1005 Tabela de Estabelecimentos"},
    ).scalar_one()
