"""seed template esocial s1030

Fase 7 (eSocial) — S-1030 (Tabela de Cargos) mapeia para OCUPACAO, com NRTIPOOCUPACAO
fixo=1 (mesmo valor que a lógica de referência usa para "cargo", em oposição a "função" —
ver S-1040). **Sem amostra real de XML disponível** para este evento em
`docs/eSocial/eventos_xml/` — os caminhos abaixo vêm da leitura direta de
`ImportacaoXmlS1030.php` (navegação de nós `evtTabCargo/infoCargo/{inclusao|alteracao}/
ideCargo` e `.../dadosCargo`), não verificados contra um XML real. Marcado explicitamente
como pendente de verificação quando uma amostra real de S-1030 estiver disponível.

Revision ID: 6b13ec762a4c
Revises: a919035382a9
Create Date: 2026-07-16 16:25:08.028442
...
revision: str = '6b13ec762a4c'
down_revision: Union[str, None] = 'a919035382a9'
branch_labels: Union[str, Sequence[str], None] = None
depends_on: Union[str, Sequence[str], None] = None

TEMPLATE_CODIGO = "ESOCIAL_S1030"
TIPO_CODIGO = "MIG_ESOCIAL_S1030"
SEM_ORIGEM = "_fixo_"
...
def upgrade() -> None:
    ...
    template_id = conn.execute(
        ...
        ),
        {
            ...
            "nome": "eSocial S-1030 — Tabela de Cargos (via Ocupação, NRTIPOOCUPACAO=1; XPath não verificado contra XML real)",
            "versao": "v_S_01_00_00",
    ...
    campos = [
        campo(ordem=1, origem=SEM_ORIGEM, rotulo="tp ocupação (fixo=1, Cargo)", campo="NRTIPOOCUPACAO",
        ...
        campo(ordem=2, origem="evtTabCargo/infoCargo/inclusao/ideCargo/iniValid | "
                              "evtTabCargo/infoCargo/alteracao/ideCargo/iniValid",
        ...
        campo(ordem=3, origem="evtTabCargo/infoCargo/inclusao/ideCargo/fimValid | "
                              "evtTabCargo/infoCargo/alteracao/ideCargo/fimValid",
        ...
        campo(ordem=4, origem="evtTabCargo/infoCargo/inclusao/ideCargo/codCargo | "
                              "evtTabCargo/infoCargo/alteracao/ideCargo/codCargo",
        ...
        campo(ordem=5, origem="evtTabCargo/infoCargo/inclusao/ideCargo/iniValid | "
                              "evtTabCargo/infoCargo/alteracao/ideCargo/iniValid",
              ...
              obrigatorio=True, regra_conversao="data_iso"),
        campo(ordem=6, origem="evtTabCargo/infoCargo/inclusao/dadosCargo/nmCargo | "
                              "evtTabCargo/infoCargo/alteracao/dadosCargo/nmCargo",
        ...
        campo(ordem=7, origem="evtTabCargo/infoCargo/inclusao/dadosCargo/codCBO | "
                              "evtTabCargo/infoCargo/alteracao/dadosCargo/codCBO",
    ...
    tipo_id = conn.execute(
        ...
        {"codigo": TIPO_CODIGO, "nome": "eSocial — S-1030 Tabela de Cargos"},
    ).scalar_one()
